...
Go to Visual Studio Code (or download it here <a href="https://code.visualstudio.com/Download" target="_blank" rel="noopener noreferrer">[https://code.visualstudio.com/Download](https://code.visualstudio.com/Download)</a> if you're using your laptop and it's not already downloaded)
...
<Callout kind="tip" collapsed="false">
  For more information on mapbox popups see: <a href="https://docs.mapbox.com/mapbox-gl-js/api/markers/#popup" target="_blank" rel="noopener noreferrer">[https://docs.mapbox.com/mapbox-gl-js/api/markers/#popup](https://docs.mapbox.com/mapbox-gl-js/api/markers/#popup)</a>
</Callout>
...
<CodeGroup default-tab="0" show-lines="true" tabs={["index.html","style.css","script.js"]}>
  ```html index.html
  <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
            <div id="map"></div>
            &lt;script src='https://api.mapbox.com/mapbox-gl-js/v3.15.0/mapbox-gl.js'&gt;&lt/script&gt;
