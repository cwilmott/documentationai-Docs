...
Move the `webmap.zip` file somewhere you'll be able to find it, and then unzip (double click for MacOSX).
...
2. &#x20;I want you to select your **data.geojson** file, and;
...
map.on('load', function() {
    map.addSource('points-data', {
        type: 'geojson',
        data: 'https://raw.githubusercontent.com/cwilmott/webmap/refs/heads/main/data/data.geojson'
    });
});
```
